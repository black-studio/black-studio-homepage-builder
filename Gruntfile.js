...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		makepot: {
			target: {
				options: {
					...
					exclude: ['build/.*'],
					potFilename: 'black-studio-homepage-builder.pot',
					processPot: function( pot ) {
						pot.headers['report-msgid-bugs-to'] = 'https://github.com/black-studio/black-studio-homepage-builder/issues\n';
		...
		checktextdomain: {
			options:{
				text_domain: 'black-studio-homepage-builder',
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		checkwpversion: {
			options:{
				readme: 'readme.txt',
				plugin: 'black-studio-homepage-builder.php'
			},
			...
			plugin_vs_internal: { //Check plugin header version against internal defined version
				version1: 'plugin',
				version2: grunt.file.read('includes/class-black-studio-homepage-builder.php').match( /version = '(.*)'/ )[1],
				compare: '=='
			}
		},
